class GetDetailPostResp {
  String? status;
  PostData? data; // Changed from List<PostData>? to PostData?
  ...
  GetDetailPostResp.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    data = json['data'] != null
        ? PostData.fromJson(json['data'])
        : null; // Modified to create single PostData object
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.data != null) {
      data['data'] =
          this.data!.toJson(); // Modified to call toJson on single object
    }
    return data;
  }
}
